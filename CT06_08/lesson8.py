...
increment_number = int(input("What is your step?"))# ask the user what is their step(the difference between 2 numbers)

for i in range(start_number,stop_number,increment_number_number):# do not -1 for the stop number as it will not work in the 2nd scenario)
    print(i)